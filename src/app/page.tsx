        ...
        <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
          <div className="container flex max-w-[64rem] flex-col items-center gap-8 text-center">
            <Link
              ...
              className="rounded-2xl bg-tremor-brand bg-opacity-20 px-4 py-1.5 text-sm font-medium"
              target="_blank"
            >
...
const LinkButton = ({
  ...
  return (
    <Link
      ...
      className={clsx(
        "text-md inline-flex h-11 items-center justify-center rounded-lg px-8 font-medium",
        className
      )}
    >
      {children}
